...
var _user$project$Ports$storePosts = _elm_lang$core$Native_Platform.outgoingPort(
	'storePosts',
	function (v) {
...
var _user$project$State$initialModel = F2(
	function (posts, route) {
		return {posts: posts, currentRoute: route, newPost: _user$project$State$emptyPost};
	});
var _user$project$State$init = F2(
	function (flags, location) {
		var posts = function () {
			var _p0 = flags;
			if (_p0.ctor === 'Just') {
				return _krisajenkins$remotedata$RemoteData$succeed(_p0._0);
			} else {
				return _krisajenkins$remotedata$RemoteData$Loading;
			}
		}();
		...
		return {
			ctor: '_Tuple2',
			_0: A2(_user$project$State$initialModel, posts, currentRoute),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	});
	...
	function (msg, model) {
		...
		switch (_p1.ctor) {
			...
			case 'LocationChanged':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							currentRoute: _user$project$Routing$extractRoute(_p1._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'UpdateTitle':
				return A4(_user$project$State$updateField, _p1._0, _p1._1, _user$project$State$setTitle, model);
			case 'UpdateAuthorName':
				return A4(_user$project$State$updateField, _p1._0, _p1._1, _user$project$State$setAuthorName, model);
			case 'UpdateAuthorUrl':
				return A4(_user$project$State$updateField, _p1._0, _p1._1, _user$project$State$setAuthorUrl, model);
			case 'SubmitUpdatedPost':
				var _p2 = A2(_user$project$Misc$findPostById, _p1._0, model.posts);
				if (_p2.ctor === 'Just') {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _user$project$Rest$updatePostCommand(_p2._0)
					};
				} else {
			...
			case 'PostUpdated':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'DeletePost':
				var _p3 = A2(_user$project$Misc$findPostById, _p1._0, model.posts);
				if (_p3.ctor === 'Just') {
					return A2(
						...
						'Found!!!',
						{
							ctor: '_Tuple2',
							_0: model,
							_1: _user$project$Rest$deletePostCommand(_p3._0)
						});
				} else {
					return A2(
						_elm_lang$core$Debug$log,
			...
			case 'NewPostTitle':
				return A3(_user$project$State$updateNewPost, _p1._0, _user$project$State$setTitle, model);
			case 'NewAuthorName':
				return A3(_user$project$State$updateNewPost, _p1._0, _user$project$State$setAuthorName, model);
			case 'NewAuthorUrl':
				return A3(_user$project$State$updateNewPost, _p1._0, _user$project$State$setAuthorUrl, model);
			case 'CreateNewPost':
				return {
					ctor: '_Tuple2',
					_0: model,
				...
				if (_p1._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								posts: A2(_user$project$State$addNewPost, _p1._0._0, model.posts),
...
var _user$project$State$updateWithStorage = F2(
	function (msg, model) {
		var _p4 = A2(_user$project$State$update, msg, model);
		var newModel = _p4._0;
		var commands = _p4._1;
		var extractedPosts = A2(
			_elm_lang$core$Maybe$withDefault,
			{ctor: '[]'},
			_krisajenkins$remotedata$RemoteData$toMaybe(newModel.posts));
		return {
			ctor: '_Tuple2',
			_0: newModel,
			_1: _elm_lang$core$Platform_Cmd$batch(
				{
					...
					_1: {
						ctor: '::',
						_0: _user$project$Ports$storePosts(extractedPosts),
						_1: {ctor: '[]'}
					}
				})
		};
...
var _user$project$App$main = A2(
	...
	_user$project$Types$LocationChanged,
	{
		...
		update: _user$project$State$updateWithStorage,
										...
										return A2(
											...
											function (title) {
												return _elm_lang$core$Json_Decode$succeed(
													{author: author, id: id, title: title});
											},
