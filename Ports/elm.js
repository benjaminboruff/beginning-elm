...
var _user$project$PortExamples$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_user$project$PortExamples$SendDataToJs),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Send Data to JavaScript'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _user$project$PortExamples$main = _elm_lang$html$Html$program(
	{init: _user$project$PortExamples$init, view: _user$project$PortExamples$view, update: _user$project$PortExamples$update, subscriptions: _user$project$PortExamples$subscriptions})();

var Elm = {};
Elm['PortExamples'] = Elm['PortExamples'] || {};
if (typeof _user$project$PortExamples$main !== 'undefined') {
    _user$project$PortExamples$main(Elm['PortExamples'], 'PortExamples', undefined);
}
